...
(por ejemplo, un buffer de 4KB es un tamaño típico).
...
func main() {
	//* NOTA 📖: Este código es simplemente explicativo y no tiene como salida un resultado real.
	...
	// para mejorar el rendimiento en ciertos escenarios donde la gestión manual de buffers es deseable.
