...
/*
* Matrices en Go
En Go, las matrices pueden definirse tanto con `arreglos` como con `slices`. La diferencia clave es que los arreglos
tienen un tamaño fijo, mientras que los slices son dinámicamente redimensionables.
...
* Ejemplos:
- Una matriz de tamaño fijo de 3x3 con arreglos se define así: `var matriz [3][3]int`.
...
func main() {
	...
	for i := 0; i < len(matriz3); i++ { // Iteramos sobre las filas
